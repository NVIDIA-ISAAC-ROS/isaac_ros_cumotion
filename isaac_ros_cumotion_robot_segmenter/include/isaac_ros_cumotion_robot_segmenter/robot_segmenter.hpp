...
private:
  ...
  rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr robot_mask_pub_;

  // Publisher for robot depth
  rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr robot_depth_pub_;
  ...
  rclcpp::Subscription<std_msgs::msg::UInt64>::SharedPtr reload_robot_description_sub_;
  ...
  void ReloadRobotDescriptionCallback(const std_msgs::msg::UInt64::SharedPtr msg);
